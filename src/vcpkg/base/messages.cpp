...
namespace vcpkg
{
    ...
    REGISTER_MESSAGE(CmdAddVersionOptSkipLicenseChk);
    REGISTER_MESSAGE(CmdAddVersionOptSkipPortfileChk);
    ...
    REGISTER_MESSAGE(CmdLintPortOptAllPorts);
    REGISTER_MESSAGE(CmdLintPortOptFix);
    REGISTER_MESSAGE(CmdLintPortOptIncreaseVersion);
